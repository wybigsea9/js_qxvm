...
; (function () {
    const $cssstyle_attribute = [
        ...
        "gridRowStart", "gridTemplate", "gridTemplateAreas", "gridTemplateColumns", "gridTemplateRows", "hyphens", "imageOrientation", "imageRendering",
        ...
        "webkitUserModify", "webkitUserSelect", "webkitWritingMode", "whiteSpace", "widows", "willChange", "wordBreak", "wordSpacing", "wordWrap",
    ...
    HTMLElement.prototype = {
        ...
        get offsetHeight() {
            if (!HTMLElement.prototype.isPrototypeOf(this)) { throw new TypeError("Illegal constructor"); };
            let result = lwVm.abs(lwVm.memory.private_data.get(this).offsetHeight, 0);
            // if ('style' in this){
            //     debugger
            //     result = this.style.height;
            // }
            console.log(this)
        ...
        get style() {
            ...
            if (!ele || Object.keys(ele).length === 0) {
                ...
                // ele = lwVm.proxy_chained(ele, 'CSSStyleDeclaration')
            ...
            if (lwVm.config.logOpen=== true) lwVm.logAdd('Get', 'HTMLElement', 'style', arguments, result);
            return result;
        },
        set style(value) {
            if (!HTMLElement.prototype.isPrototypeOf(this)) { throw new TypeError("Illegal constructor"); };
