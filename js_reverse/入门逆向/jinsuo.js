...
function hex2b64(t) {
    ...
    for (e + 1 == t.length ? (r = parseInt(t.substring(e, e + 1), 16),
            ...
            n += b64map.charAt(r >> 2) + b64map.charAt((3 & r) << 4));
        (3 & n.length) > 0;)
        n += b64pad;
    return n
}
...
function (t) {
    function e(t, e, r, n, i, o, a) {
        return t = t + (e & r | ~e & n) + i + a, (t << o | t >>> 32 - o) + e
    }

    function r(t, e, r, n, i, o, a) {
        return t = t + (e & n | r & ~n) + i + a, (t << o | t >>> 32 - o) + e
    }

    function n(t, e, r, n, i, o, a) {
        return t = t + (e ^ r ^ n) + i + a, (t << o | t >>> 32 - o) + e
    }

    function i(t, e, r, n, i, o, a) {
        return t = t + (r ^ (e | ~n)) + i + a, (t << o | t >>> 32 - o) + e
    }
...
CryptoJS.lib.Cipher || function (t) {
        ...
        var g = r.CipherParams = n.extend({
            ...
            h = (e.format = {}).OpenSSL = {
                stringify: function (t) {
                        var e = t.ciphertext;
                        return t = t.salt, (t ? i.create([1398893684, 1701076831]).concat(t).concat(e) : e).toString(a)
                    },
                    parse: function (t) {
                        t = a.parse(t);
                        var e = t.words;
...
function getpass(pwd,publickey,ponent) {

    var e = new RSAKey;
    e.setPublic(publickey,ponent);
