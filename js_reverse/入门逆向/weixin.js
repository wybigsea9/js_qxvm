...
function a(n, r) {
    n[r >> 5] |= 128 << r % 32,
    n[14 + (r + 64 >>> 9 << 4)] = r
    var t, u, a, h, d, g = 1732584193,
    l = -271733879,
    v = -1732584194,
    s = 271733878
    for (t = 0; t < n.length; t += 16) u = g,
    a = l,
    h = v,
    d = s,
...
function g(n) {
    ...
    e += "0123456789abcdef".charAt(r >>> 4 & 15) + "0123456789abcdef".charAt(15 & r); return e
}
...
function s(n, r) {
    return function(n, r) {
        ...
        o = [],
        c = []
        for (o[15] = c[15] = void 0, u.length > 16 && (u = a(u, 8 * n.length)), t = 0; t < 16; t += 1) o[t] = 909522486 ^ u[t],
        c[t] = 1549556828 ^ u[t]
