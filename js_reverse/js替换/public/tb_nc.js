                    ...
                    return NoCaptcha.prototype = {
                            ...
                            loadUM: function() {
                                ...
                                window._umopt_npfp = 1,
                                    ...
                                    "FFFF0N0N0000000085DE" !== opt.appkey && "FFFF0N000000000085DE" !== opt.appkey && "FFFF0N1N0000000085DE" !== opt.appkey && "FFFF0N000000000097AD" !== opt.appkey || (window._umopt_npfp = 0),
                                        ...
                                        _.jsonp({
                                            ...
                                            success: function(e) {
                                                if (e.result.question && (e.result.question = e.result.question.replace(/<span[^>]+?>/g, "<i>"),
                                                    ...
                                                    s = !0,
                                                    l != -1) {
                                                    if (clearTimeout(l), !e.result.tags)
                                ...
                                this.__inn && (this.__inn = 0,
                                        ...
                                        u && (u = u.getElementsByTagName("input")[0]) && _.addHandler(u, "keydown", function(e) {
                                            if (e = e || window.event,
                                                ...
                                                return i(),
                                                    e.preventDefault ? e.preventDefault() : window.event.returnValue = !1, !1
                                        })),
                                    onNCEvent(event_names.afterverify),
                                    onNCEvent(event_names.after_code)
                            },
                        ...
                        return _createClass(Scrape, [{
                                ...
                                value: function() {
                                    var e = this,
                                        ...
                                        n = t.objectPoints,
                                        o = n.points;
                                    if (this._points = o, !o || !Array.isArray(o) || o.length !== n.objectPointsCount)
                                ...
                                value: function(e) {
                                    ...
                                    switch (i) {
                                        case "3A":
                                            r = r.concat(t), !n && this.nc._log("ERR_SLIDE_TOO_FAST", "too few mp", "{code: 201, str:" + r + "}"),
                                                a = "201";
                                            break;
                                        case "4A":
                                            t = [this.session_id, win._n_bak],
                                                r = r.concat(t), !n && this.nc._log(ERR_CODE_API_FAIL + "_analyze", "blocked", "{code: 101, str:" + r + "}"),
                                                a = "101";
                                            break;
                                        case "5A":
                                            t = [this.session_id, win._n_bak],
                                                r = r.concat(t), !n && this.nc._log(ERR_CODE_API_FAIL + "_analyze", "blocked", "{code: 301, str:" + r + "}"),
                                                a = "301"
                                    }
                                    ...
                                    return new Promise(function(t, n) {
                                        try {
                                            ...
                                            if (e.root.innerHTML = kvTpl.render(html, {
                                                ...
                                                e.render_bg(),
                                                e.el_canvas = e.getEl("canvas"), !e.el_canvas.getContext || !(e.ctx = e.el_canvas.getContext("2d")))
                                                return e.downgrade(),
                                                    e.render_surface_dg(),
                                                    void t();
                                            e.render_surface(),
