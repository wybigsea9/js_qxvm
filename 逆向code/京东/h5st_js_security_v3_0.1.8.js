var ParamsSign = function () {
    ...
    var N, D, F = function (t, r) {
        ...
        }, at = h({}.isPrototypeOf), ct = "undefined" != typeof navigator && String(navigator.userAgent) || "", ut = n,
        st = ct, ft = ut.process, lt = ut.Deno, pt = ft && ft.versions || lt && lt.version, dt = pt && pt.v8;
    ...
    var pe = Kr
        ...
        , Ee = function (t, r) {
            var e, n, o, i, a, c, u, s, f, l = t.target, p = t.global, d = t.stat, v = t.proto,
                h = p ? he : d ? he[l] : (he[l] || {}).prototype, y = p ? Se : Se[l] || xe(Se, l, {})[l], g = y.prototype;
            for (i in r)
    ...
    ;
    var Wn, $n = it("document", "documentElement"), Vn = te, zn = Mn, Kn = Sn, Xn = vn, Yn = $n, Qn = Or,
        Zn = "prototype", to = "script", ro = Ie("IE_PROTO"), eo = function () {
        }, no = function (t) {
            return "<" + to + ">" + t + "</" + to + ">"
        }, oo = function (t) {
            t.write(no("")),
    ...
    var Eo = "[object z]" === String(_o)
        ...
        , ci = ai.prototype
        , ui = function (t, r, e) {
        var n, o, i, a, c, u, s, f = e && e.that, l = !(!e || !e.AS_ENTRIES), p = !(!e || !e.IS_RECORD),
            d = !(!e || !e.IS_ITERATOR), v = !(!e || !e.INTERRUPTED), h = Ko(r, f), y = function (t) {
    ...
    var Ii, Ai, Ri, Li = E, Ci = n.WeakMap, Mi = Li(Ci) && /native code/.test(String(Ci)), Ni = n, Di = Z, Fi = ve,
        Gi = Kt, Bi = qt, Hi = Ie, qi = vn, Ui = "Object already initialized", Ji = Ni.TypeError, Wi = Ni.WeakMap;
    if (Mi || Bi.state) {
    ...
    var ha = {
        ...
        var c, u, s, f = function (t) {
            ...
            }, l = r + " Iterator", p = !1, d = t.prototype, v = d[qa] || d["@@iterator"] || o && d[o],
            h = !Ha && v || f(o), y = "Array" == r && d.entries || v;
    ...
    var Ic, Ac, Rc, Lc, Cc = !Oc || mc((function () {
            ...
            return t
        }, $c = /(?:ipad|iphone|ipod).*applewebkit/i.test(ct), Vc = n, zc = f, Kc = zr, Xc = E, Yc = Kt, Qc = o, Zc = $n,
        tu = Uc, ru = Or, eu = Wc, nu = $c, ou = oc, iu = Vc.setImmediate, au = Vc.clearImmediate, cu = Vc.process,
        uu = Vc.Dispatch, su = Vc.Function, fu = Vc.MessageChannel, lu = Vc.String, pu = 0, du = {},
    ...
    var Su, ju, xu, Ou, _u, Eu = wu, Tu = /ipad|iphone|ipod/i.test(ct) && "undefined" != typeof Pebble,
        Pu = /web0s(?!.*chrome)/i.test(ct), ku = n, Iu = zr, Au = T.f, Ru = bu.set, Lu = Eu, Cu = $c, Mu = Tu, Nu = Pu,
        Du = oc, Fu = ku.MutationObserver || ku.WebKitMutationObserver, Gu = ku.document, Bu = ku.process,
        Hu = ku.Promise, qu = Au(ku, "queueMicrotask"), Uu = qu && qu.value;
    if (!Uu) {
        var Ju = new Lu
            , Wu = function () {
            var t, r;
    ...
    var Om = Object.freeze({
        ...
        getRandomIDPro: function () {
            var t, r = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, e = r.size,
                n = void 0 === e ? 10 : e, o = r.dictType, i = void 0 === o ? "number" : o, a = r.customDict, c = "";
    ...
    function ib() {
        var t, r = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : Gy(),
            e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "yyyy-MM-dd", n = new Date(r), o = e,
            i = {
                "M+": n.getMonth() + 1,
                "d+": n.getDate(),
                "D+": n.getDate(),
    ...
    var ub = function () {
        ...
        return Ch(t, [{
            key: "__iniConfig",
            value: function (t) {
                var r, e = t.appId, n = t.debug, o = t.retry2load, i = t.onSign, a = t.onRequestToken,
